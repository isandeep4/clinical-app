...
function Home(){
    ...
    const fetchPatients = () => {
        axios.get("http://localhost:8080/clinicalservices/api/patients").then(res=>setPatientData(res.data));
        setLoading(false);
    }
        ...
        return (<div>
            ...
            <table align='center'>
                ...
                <tbody>
                {!isLoading?patientData.map(patient=><RowCreator key={patient.id} item={patient}/>):""}
